...
![](images/daphna-keynote.png){width=50%}

Placeholder image, abstract/bio TBA

:::
::: {.column width="50%"}
## Hadley Wickham{#keynote_hadley}
### *What’s New with LLMs for Data Science*

![](images/hadley-keynote.png){width=50%}
...
Open the sections below to read the abstracts of the talks (and speaker bios?).

## Talks Session I{#talks_1}

::: {.callout-note collapse=true icon=false appearance="simple"}
### *Intersectionality in LGBTQ+ Health Research: Practical Analysis in R Using Upset Plots*  (Chris Battiston)
**Abstract:**
...
::: {.callout-note collapse=true icon=false appearance="simple"}
### *High, Low, Jack, & Claude: AI-Assisted Shiny Development*  (Jasmine Daly)
**Abstract:**
...
::: {.callout-note collapse=true icon=false appearance="simple"}
### *Queer Stories Through Data: Lighting LGBTQ+ Cinema with R and Shiny*  (Njoki Njuki and Tamires Martins)
**Abstract:**
...
::: {.callout-note collapse=true icon=false appearance="simple"}
### *Belonging is Political: Measuring Queer Sense of Belonging in Higher Ed Using R*  (J. Audra Williams)
**Abstract:**
...
::: {.callout-note collapse=true icon=false appearance="simple"}
### *The Cheesecake ROI: Building a Marketing Mix Model with Tidymodels and The Golden Girls*  (Ryan Timpe)
**Abstract:**
...
::: {.callout-note collapse=true icon=false appearance="simple"}
### *Migrating legacy code to R: A team-based approach to open-source adoption*  (Joshua Gutoskie)
**Abstract:**
...
- *Beyond Drag Bingo: Building community at work* (Kristin Bott)
- *Teaching Pharmacokinetics with Confidence: How R Helps Students “See” the Science* (Rafael Henry-Venson)
- *Factor or Network? Modeling the Complexity of Gender Minority Stress in Transgender Communities* (Noah Pevie)
- *Elevating Open Data: Creating 3D Visuals with NYC Open Climate Data* (Ursula Kaczmarek)
- *Seeing what's missing: visualization of incomplete and imputed data* (Hanne Oberman)
- *The Two Step Method: Accurate Record Keeping for Sex and Gender* (Trystan Washburne)
