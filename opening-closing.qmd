...
![](images/people/committee.svg){fig-align="center"}

## Speakers {footer="false"}

![](images/people/speakers.svg){fig-align="center"}

## Workshop and social leaders {footer="false"}

![](images/people/workshops-socials.svg){fig-align="center"}
...
::: {.column width="30%"}
![](images/sponsors/JumpingRivers_Primary.png){width="80%"}
:::

::: {.column width="30%"}
![](images/sponsors/ols-transparent-bg.png){width="60%"}
:::
