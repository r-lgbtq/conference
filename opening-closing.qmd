...
title-slide-attributes:
  ...
  data-footer: "false"
  data-notes: |
    - Introduce myself - co-founder and chair of rainbowR community
    - Inaugural, excitment, size of conf, 85% new to rR
...
::: {.notes}
We want to balance being able to share material from the conference more widely with creating a safe environment for folks joining live.
...
::: {.notes}
- meetups in two time-zones
- link to conference buddies
- LGBTQ+ datasets
...
:::{.notes}
So, if you're LGBTQ+ and want to join a vibrant and supportive community of fellow R enthusiasts, or you're someone interested in promoting LGBTQ+ people and issues in the R community and beyond, please visit our website, rainbowr.org, to get involved. Thank you.
:::



::: {.notes}
Around 80% of LGBTQ+ folks who registered not (yet) members
:::
